...
import { WorkoutStats, Workout, LeaderboardEntry, User } from '../types';
...
export default function Dashboard({ stats, workouts, leaderboard = [], currentUser }: DashboardProps) {
  ...
  return (
    <div className="space-y-5 sm:space-y-6 relative z-10">
      {/* 0. Employee Activity Highlights Card */}
      <HighlightSection workouts={workouts} stats={stats} leaderboard={leaderboard} currentUser={currentUser} />
